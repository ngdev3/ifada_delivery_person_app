					...
					<div class="prodcut_main_container">
						<div class="products_wrapper">
							<div class="col-md-3 col-sm-3 col-xs-3 items_img_div">
								<a href="value_packs1.php"><img class="img-responsive sub_cat_product_img" src="assets/img/product/product_8.png"></a>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-6 sub_product_desc">
								...
								<a href="value_packs1.php"><p class="sub_produt_name">Fuits & Vegetables</p></a>
