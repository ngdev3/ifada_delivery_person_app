					...
					<div id="" class="owl-carousel owl3 owl-theme">
						...
						<div class="item">
							<div class="prod_images">
								<img class="img-responsive" src="assets/img/product/values_pack1s.png">
							</div>
						</div>
						<div class="item">
							<div class="prod_images">
					...
					<div class="prodcut_main_container">
						<div class="products_wrapper">
							<div class="col-md-3 col-sm-3 col-xs-3 items_img_div">
								<img class="img-responsive sub_cat_product_img" src="assets/img/product/product_7.png">
							</div>
							<div class="col-md-6 col-sm-6 col-xs-6 sub_product_desc">
								...
								<p class="sub_produt_name">Combo Pack of 3</p>
								<p class="sub_product_qty">Quantity : <span>3</span></p>
