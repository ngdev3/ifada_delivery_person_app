		...
		<div class="row">
			<div class="">
				...
				<div class="pulses_buttons mb-20 mt-10">
					<div id="" class="owl-carousel owl2 owl-theme">
						<!-- Buttons Items -->
						<div class="item">
							<input type="button" class="btn btn-success all-sub-cat_first" name="" value="All">
						</div>
						<div class="item">
							<input type="button" class="btn btn-success all-sub-cat_buttons" name="" value="Sub-Category 1">
						</div>
						<div class="item">
